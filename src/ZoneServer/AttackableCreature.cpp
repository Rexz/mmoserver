                    ...
                    if (inventory)
                    {
                        ...
                        if (lootedCredits > 0)
                        {
                            ...
                            else
                            {
                                ...
                                // BString lootCreditsString(str);
                                // lootCreditsString.convert(BSTRType_Unicode16);
                                gThreadSafeMessageLib->SendSystemMessage(::common::OutOfBand("base_player", "prose_coin_loot", "", "", getSpeciesGroup().getAnsi(), getSpeciesString().getAnsi(), "", "", lootedCredits, 0.0f), playerObject);
