...
private:
	...
	*/
    ...
    uint64 volatile             mLastPacketReceived;      // General session timeout - we determine the time we last received a packet from a session to decide whether to disconnect it
