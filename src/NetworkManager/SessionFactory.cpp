...
SessionFactory::SessionFactory(SocketWriteThread* writeThread, Service* service, PacketFactory* packetFactory, ThreadedMessageFactory* messageFactory, bool serverservice, NetworkConfig& network_configuration)
